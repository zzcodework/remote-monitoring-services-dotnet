...
adapters, in `appsettings.ini`. The INI format allows storage of values in
a readable format, with comments. The application also supports inserting
...
[iothub-manager.sln.DotSettings](iothub-manager.sln.DotSettings)
