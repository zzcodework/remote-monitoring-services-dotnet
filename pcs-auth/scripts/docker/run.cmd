...
echo Starting Auth ...
docker run -it -p %PCS_AUTH_WEBSERVICE_PORT%:%PCS_AUTH_WEBSERVICE_PORT% ^
    -e PCS_AUTH_WEBSERVICE_PORT=%PCS_AUTH_WEBSERVICE_PORT% ^
    -e "PCS_AUTH_PROTOCOLS=%PCS_AUTH_PROTOCOLS%" ^
