...
1. Open the solution using the `pcs-auth.sln` file.
...
1. Add a new environment variable with name
   `PCS_AUTH_WEBSERVICE_PORT` and value `9001`.
...
We also provide a
[Java version](https://github.com/Azure/pcs-auth-java)
...
[pcs-auth.sln.DotSettings](pcs-auth.sln.DotSettings)
